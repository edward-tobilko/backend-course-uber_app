...
// ? createCommand - это утилита для унификации бизнес-команд в системе. Она упаковывает данные (payload) со служебными параметрами (meta), которые определяют, как команда должна быть выполнена: в транзакции или нет, с прокидыванием ошибок или тихим фейлом.
